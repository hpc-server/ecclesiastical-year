...
class CantateSundayRule extends AbstractRules implements InterfaceRules
{
    /**
     * @param string $input
     *
    ...
    public function checkDate($input)
    {
        ...
        $this->setName();
        return ($this->inputValue == ($this->datePentecost - (21 * self::SECONDS_PER_DAY)));
    }
