...
class LaetareSundayRule extends AbstractRules implements InterfaceRules
{
    /**
     * @param string $input
     *
    ...
    public function checkDate($input)
    {
        ...
        $this->setName();
        return ($this->inputValue == ($this->dateEaster - (21 * self::SECONDS_PER_DAY)));
    }
