...
class AscensionOfJesusDayRule extends AbstractRules implements InterfaceRules
{
    /**
     * @param string $input
     *
    ...
    public function checkDate($input)
    {
        ...
        $this->setName();
        return ($this->inputValue == ($this->dateEaster + (39 * self::SECONDS_PER_DAY)));
    }
    ...
    {
        $this->DateName = 'Christi Himmelfahrt';
    }
}