...
class QuasimodoSundayRule extends AbstractRules implements InterfaceRules
{
    /**
     * @param string $input
     *
    ...
    public function checkDate($input)
    {
        ...
        $this->setName();
        return ($this->inputValue == ($this->datePentecost - (42 * self::SECONDS_PER_DAY)));
    }
