...
class ChristmasDayRule extends AbstractRules implements InterfaceRules
{
    /**
     * @param string $input
     *
    ...
    public function checkDate($input)
    {
        ...
        $this->setName();
        return ($this->inputValue == ($this->dateChristmasEve + (1 * self::SECONDS_PER_DAY)));
    }
    ...
    {
        $this->DateName = '1. Weihnachtsfeiertag';
    }
}