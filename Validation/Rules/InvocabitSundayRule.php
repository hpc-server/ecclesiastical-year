...
class InvocabitSundayRule extends AbstractRules implements InterfaceRules
{
    /**
     * @param string $input
     *
    ...
    public function checkDate($input)
    {
        ...
        $this->setName();
        return ($this->inputValue == ($this->dateEaster - (42 * self::SECONDS_PER_DAY)));
    }
